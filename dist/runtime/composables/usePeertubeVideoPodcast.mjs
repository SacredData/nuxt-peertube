...
export const usePeertubeVideoPodcast = async (id = null, client = { access_token: "" }) => {
  try {
    ...
    if (client.access_token && client.access_token instanceof String && client.access_token !== "") {
      fetchOpts["headers"] = {
