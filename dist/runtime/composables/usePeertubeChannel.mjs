...
export const usePeertubeChannel = async (id, access_token) => {
  try {
    ...
    const {
      ...
      const headers = access_token instanceof String ? { Authorization: `Bearer ${access_token}` } : {};
      const [channel2, videos2] = await Promise.all([
      ...
      return { channel: channel2, videos: videos2 };
    });
